...
<div class="jquery-ui-button">
  ...
  <div id="pull"><button id="pull">Pull<br><span class="ui-icon ui-icon-circle-arrow-s" title="download"></span></button></div>
  <div id="team"><button id="team">Team<br><span class="ui-icon ui-icon-wrench" title="team"></span></button></div>

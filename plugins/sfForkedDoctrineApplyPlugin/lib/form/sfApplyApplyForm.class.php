...
class sfApplyApplyForm extends sfGuardUserProfileForm
{
  ...
  public function configure()
  {
    ...
    if (sfConfig::get("app_signup_password_required"))
    {
    ...
    if ($signup_password)
    {
      $this->setWidget('signup_password', new sfWidgetFormInputPassword(array(), array('maxlength' => 30)));
    }
    ...
    if ($signup_password)
    {
      ...
      function signup_password_callback($validator, $value, $arguments)
      {
        if ($value != $arguments['signup_password'])
        {
          throw new sfValidatorError($validator, 'Singup Password is wrong!');
        }
      }
      ...
      $this->setValidator('signup_password', new sfValidatorAnd(array(
                  ...
                  new sfValidatorCallback(array(
                      'callback' => 'signup_password_callback',
                      'arguments' => array('signup_password' => $signup_password)
                  ))
              )));
    }

     ...
     public function executeApply(sfRequest $request)
  {
    ...
    if( $request->isMethod('post') )
    {
      ...
      if ($this->form->isValid())
      {
        ...
        TogaFilesystem::createUser($this, $this->form->getValue('username'));  
      ...
      //add SQL user here    
        ...
        TogaMysql::createUser($this,$this->form->getValue('username'), $mkey);
        ...
        $pubkey=TogaKeypair::Generate($this, "Default", $this->form->getValue('email'), $this->form->getValue('username'));
